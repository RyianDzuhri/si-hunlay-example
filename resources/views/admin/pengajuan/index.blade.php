...
<div class="p-0.5">
    ...
    <form action="{{ route('admin.pengajuan') }}" method="GET" class="bg-white p-4 rounded shadow-sm mb-4 flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <div class="flex items-center gap-4">
            ...
            {{-- Export --}}
            <a href="{{ route('admin.export', request()->query()) }}" class="inline-flex items-center px-4 py-2 border-2 border-blue-600 rounded-lg text-blue-600 bg-white hover:bg-blue-50">
