        ...
        <ul class="space-y-2">
          ...
          <li>
            <a href="#" class="flex items-center gap-2 text-gray-700 hover:bg-blue-100 px-3 py-2 rounded-lg {{ request()->is('daftar-tugas') ? 'bg-blue-100 font-semibold' : '' }}">
              <img src="{{ asset('images/DaftarTugas.png') }}" alt="Daftar Tugas Icon" class="w-5 h-5">
              Daftar Tugas
            </a>
          </li>
          <li>
            <a href="#" class="flex items-center gap-2 text-gray-700 hover:bg-blue-100 px-3 py-2 rounded-lg {{ request()->is('verifikasi-lapangan') ? 'bg-blue-100 font-semibold' : '' }}">
              <img src="{{ asset('images/VerifikasiLapangan.png') }}" alt="Verifikasi Lapangan Icon" class="w-5 h-5">
              Verifikasi Lapangan
            </a>
          </li>
        </ul>
    ...
    <div class="flex-1 flex flex-col">
      ...
      <header class="bg-white shadow-sm px-6 py-4 flex justify-end items-center">
        <div class="flex items-center gap-4">
          ...
          <span class="text-gray-700 font-semibold">Krisnaaaaa</span>
        </div>
      </header>
